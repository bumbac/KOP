...
display(plot([p for p in x], Layout(title="Error based on terminal temperature.", xaxis_title="terminal temperature", yaxis_title="error")))

display(plot([p for p in z], Layout(title="N. of iterations based on terminal temperat.", xaxis_title="terminal temperature", yaxis_title="# iterations")))
